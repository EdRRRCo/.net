...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static string connectionString = "Server = 127.0.0.1; Database = student; User ID = root; Password = 123456; port = 3306; CharSet = utf8mb4; pooling = true;";//PubConstant.ConnectionString;
